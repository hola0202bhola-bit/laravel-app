...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('ingredients')->insertOrIgnore([
            ['id' => 1, 'nombre' => 'Café Arábica en Grano', 'stock_actual' => 50000.0, 'unidad_medida' => 'g'],
            ['id' => 2, 'nombre' => 'Leche Entera', 'stock_actual' => 40000.0, 'unidad_medida' => 'ml'],
            ['id' => 3, 'nombre' => 'Leche de Almendras', 'stock_actual' => 20000.0, 'unidad_medida' => 'ml']
        ]);
        ...
        $products = [
            ['codigo' => 1, 'nombre' => 'Americano Tradicional', 'precio' => 35.00, 'existencia' => 15, 'imagen' => '/assets/americano_cup.png', 'descripcion' => 'Café negro suave elaborado con granos arábicos de tueste medio.', 'extras' => $standardExtras],
            ['codigo' => 2, 'nombre' => 'Cappuccino Art', 'precio' => 45.50, 'existencia' => 10, 'imagen' => '/assets/cappuccino_art.png', 'descripcion' => 'Espresso con leche al vapor y capa abundante de espuma con arte barista.', 'extras' => $standardExtras],
            ['codigo' => 3, 'nombre' => 'Muffin de Chocolate', 'precio' => 28.00, 'existencia' => 12, 'imagen' => '/assets/chocolate_muffin.png', 'descripcion' => 'Muffin esponjoso horneado diariamente con chispas de chocolate semi-amargo.', 'extras' => []],
            ['codigo' => 4, 'nombre' => 'Espresso Italiano', 'precio' => 30.00, 'existencia' => 20, 'imagen' => '/assets/americano_cup.png', 'descripcion' => 'Extracción concentrada de café con crema dorada y aroma intenso.', 'extras' => $standardExtras],
            ['codigo' => 5, 'nombre' => 'Latte Vainilla', 'precio' => 48.00, 'existencia' => 15, 'imagen' => '/assets/cappuccino_art.png', 'descripcion' => 'Espresso combinado con abundante leche cremosa y toque sutil de vainilla.', 'extras' => $standardExtras],
            ['codigo' => 6, 'nombre' => 'Flat White', 'precio' => 46.00, 'existencia' => 8, 'imagen' => '/assets/cappuccino_art.png', 'descripcion' => 'Doble shot de espresso con microespuma tersa de leche.', 'extras' => $standardExtras],
            ['codigo' => 7, 'nombre' => 'Mocha de Caramelo', 'precio' => 52.00, 'existencia' => 12, 'imagen' => '/assets/cappuccino_art.png', 'descripcion' => 'Espresso con chocolate fino, leche, jarabe de caramelo y crema batida.', 'extras' => $standardExtras],
            ['codigo' => 8, 'nombre' => 'Croissant Clásico', 'precio' => 32.00, 'existencia' => 10, 'imagen' => '/assets/croissant_pastry.png', 'descripcion' => 'Hojaldre mantequilloso crujiente por fuera y suave por dentro.', 'extras' => []],
            ['codigo' => 9, 'nombre' => 'Tarta de Cheesecake', 'precio' => 45.00, 'existencia' => 6, 'imagen' => '/assets/chocolate_muffin.png', 'descripcion' => 'Cheesecake cremoso estilo Nueva York con base de galleta crocante.', 'extras' => []],
            ['codigo' => 10, 'nombre' => 'Galleta Chispas', 'precio' => 22.00, 'existencia' => 25, 'imagen' => '/assets/chocolate_muffin.png', 'descripcion' => 'Galleta tradicional recién horneada repleta de chispas de chocolate.', 'extras' => []],
            ['codigo' => 11, 'nombre' => 'Matcha Latte', 'precio' => 50.00, 'existencia' => 10, 'imagen' => '/assets/cappuccino_art.png', 'descripcion' => 'Té verde matcha de grado ceremonial batido con leche espumada.', 'extras' => $standardExtras],
            ['codigo' => 12, 'nombre' => 'Frappé de Oreo', 'precio' => 55.00, 'existencia' => 15, 'imagen' => '/assets/cappuccino_art.png', 'descripcion' => 'Bebida helada licuada con galletas Oreo, crema y jarabe de chocolate.', 'extras' => $standardExtras],
            ['codigo' => 13, 'nombre' => 'Cold Brew Tonic', 'precio' => 42.00, 'existencia' => 18, 'imagen' => '/assets/americano_cup.png', 'descripcion' => 'Café extraído en frío durante 18 horas servido con agua tónica y hielo.', 'extras' => $standardExtras],
            ['codigo' => 14, 'nombre' => 'Bagel de Queso Crema', 'precio' => 38.00, 'existencia' => 10, 'imagen' => '/assets/croissant_pastry.png', 'descripcion' => 'Bagel tostado untado con rico queso crema con finas hierbas.', 'extras' => []],
            ['codigo' => 15, 'nombre' => 'Brownie con Nuez', 'precio' => 25.00, 'existencia' => 14, 'imagen' => '/assets/chocolate_muffin.png', 'descripcion' => 'Brownie fudgy intenso de chocolate acompañado de trozos de nuez troceada.', 'extras' => []]
        ];
